        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            using (var db = new DatabaseContext())
            {
               ...
               /* Adresa adr = new Adresa();
                ...
                k1.DatumVremeKomentara = DateTime.Now;
                k1.Id = 1;
                k1.Autor = o;
                k1.Sadrzaj = "Komentaaaaaar";

                Komentar k2 = new Komentar();
                k2.DatumVremeKomentara = DateTime.Now;
                k2.Id = 2;
                k2.Autor = o;
                k2.Sadrzaj = "Komentaaaaaar2";
                ...
                z1.Status = "U obradi";
                z1.Komentari = new List<Komentar>();
                z1.Komentari.Add(k1);
                z1.Komentari.Add(k2);
                ...
                z2.Status = "U obradi";
                z2.Komentari = new List<Komentar>();
                ...
                z3.Status = "U obradi";
                z3.Komentari = new List<Komentar>();
                ...
                z4.Status = "U obradi";
                z4.Komentari = new List<Komentar>();
